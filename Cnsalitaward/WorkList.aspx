<%@ Page Language="C#" MasterPageFile="~/User.Master"  AutoEventWireup="true" CodeBehind="WorkList.aspx.cs" Inherits="Cnsalitaward.WorkList"  %>
 ...
 <!--    <div style="font-size:1vw; color:red;" class="Noto"><span class="NOtoB">2차 운영기간에 작품 감상이 가능합니다.</span><br>기다려주세요.</div> -->
           ...
           <div style="margin-left: 14.7VW;margin-top:4.2VW ;width: 100%;">
            <div style=" float: left;font-size:0.8333333333333334VW; background-color:#5A5A5A;color:white; border:solid 0.05VW;width: 35.3125VW; height: 1.9270833333333335VW; text-align:center;padding-top:0.5208333333333333VW ">운문</div>
             <div onclick="location.href='WorkList2.aspx'" style="cursor:pointer ;font-size:0.8333333333333334VW;float: left; color:#5A5A5A;border:solid 0.05VW;width: 35.3125VW; height: 1.875VW; text-align:center;padding-top:0.5208333333333333VW">산문</div>
              </div>


     
     
       <div  class="Dokdo" style="font-size:3.5VW; padding-top: 2.2VW; margin-left:48VW">운문</div>
        ...
        <tr>
           ...
           <%
               ...
               try
               {
                   ...
                   else if (Request.QueryString["contentsSearch"] != null)
                   {
                       ...
                       foreach (var work in workList)
                       {
                           ...
                           Response.Write("<div class=\"Noto\" style=\"text-align: center; float:left; width:11.9VW; font-color:#5A5A5A ;padding:0.88VW ;height:2.8VW\";>" + work.Like + "</div>");
               ...
               %> 
           <div style="text-align: center; margin-top: 30.8VW;margin-bottom:5vw">
               <span>
                   <strong><b>
               ...
               <%
                       ...
                       if (pageCount / 10 == page / 10)
                       {
                           if (page % 10 != 0)
                           {
                               for (int i = 1; i <= pageCount % 10; i++)
                               {
                                   ...
                                   Response.Write("<a" + textStyle + " href=\"/WorkList.aspx?page=" + (i + ((page / 10) * 10)) + queryText + "\">" + (i + ((page / 10) * 10)) + "</a>");
                                   Response.Write("</span>");
                               }
                           }
                           else
                           {
                               ...
                               for (int i = 1; i <= 10; i++)
                               {
                                   ...
                                   Response.Write("<span" + pageStyle + " style=\"padding: 0.15VW 0.46VW; margin: 0.15VW;\">");
                                   Response.Write("<a" + textStyle + " href=\"/WorkList.aspx?page=" + (i + page - 10) + queryText + "\">" + (i + page - 10) + "</a>");
                                   Response.Write("</span>");
                               }
                           }
                       }
                   ...
                   else
                   {
                       ...
                       for (int i = 1; i <= 10; i++)
                       {
                           ...
                           Response.Write("<span" + pageStyle + " style=\"padding: 0.15VW 0.46VW; margin: 0.15VW;\">");
                           Response.Write("<a" + textStyle + " href=\"/WorkList.aspx?page=" + i + queryText + "\">" + i + "</a>");
                           Response.Write("</span>");
                       }
                   }
