       ...
       <div  class="Dokdo" style="font-size:3.5VW; padding-top: 2.2VW; margin-left:47VW">비평문</div>
        ...
        <tr>
           ...
           <%
               ...
               %> 
     <div style="height: 2.5vw; display:flex; align-items:center; justify-content:center; cursor:pointer;margin-top:32vw;margin-left:79vw;background-color:#002897;color:white; border-radius:20px; font-size:1vw; display:none;" onclick="location.href='UploadCritic.aspx'"class="writecritic" >비평하기</div>
